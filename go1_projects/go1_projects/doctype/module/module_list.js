function gi(listview) {
    ...
    if (checked_bugs.length > 0) {
        frappe.call({
            method: "go1_projects.go1_projects.doctype.module.module.get_users",
            args: {
                "names": checked_bugs,
            },
            callback: function(r) {
                ...
                if (r.message) {
                    ...
                    var d = new frappe.ui.Dialog({
                        ...
                        primary_action: function() {
                            ...
                            var method = "go1_projects.go1_projects.doctype.module.module.post";
                    ...
                    d.show();
                } else { frappe.msgprint('Projects related to the modules are not shared to any users!!!') }

            }
        });
    } else {
        frappe.msgprint("Please Select the Modules to be shared")
    }
}

frappe.listview_settings['Module'] = {
